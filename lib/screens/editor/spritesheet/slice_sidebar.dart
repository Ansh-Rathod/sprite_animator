...
class SliceSidebar extends StatelessWidget {
  ...
  final VoidCallback onAutoSlice;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: NumberBox(
                  ...
                  onChanged: (v) {
                    ...
                    onChanged(
                      slice.copyWith(
                        cellSize: Size(slice.cellSize.width, v),
                      ),
                    );
                  },
                ),
              ...
              Expanded(
                child: NumberBox(
                  ...
                  onChanged: (v) {
                    ...
                    onChanged(
                      slice.copyWith(
                        offset: Offset(v, slice.offset.dy),
                      ),
                    );
                  },
                ),
              ...
              Expanded(
                child: NumberBox(
                  ...
                  onChanged: (v) {
                    ...
                    onChanged(
                      slice.copyWith(
                        offset: Offset(slice.offset.dx, v),
                      ),
                    );
                  },
                ),
          ...
          const Spacer(),
          FilledButton(
            onPressed: onAutoSlice,
            child: const Text('Auto Slice'),
          ),
        ],
      ),
    );
